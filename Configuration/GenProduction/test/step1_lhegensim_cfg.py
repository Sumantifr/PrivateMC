...
# with command line options: Configuration/GenProduction/python/Hadronizer_NMSSM_XToYHto4B_dipoleRecoilOn_TuneCP5_13p6TeV_madgraph_pythia8.py --python_filename step1_lhegensim_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:step1_lhegensim.root --conditions 140X_mcRun3_2024_realistic_v26 --beamspot DBrealistic --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(123456)
#process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(250) --step LHE,GEN,SIM --geometry DB:Extended --era Run3_2024 --no_exec --mc -n 10
import os
import FWCore.ParameterSet.VarParsing as VarParsing
options = VarParsing.VarParsing ('standard')
#options.register('gridpack',  '/eos/user/c/chatterj/XtoYH/Run3/VBF/Gridpacks/NMSSM_XToYH_VBF_MX_1000_MY_125_el9_amd64_gcc11_CMSSW_13_2_9_tarball.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
options.register('gridpack',  'Gridpacks/NMSSM_XToYH_VBF_MX_1000_MY_125_el9_amd64_gcc11_CMSSW_13_2_9_tarball.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Hadronizer_NMSSM_XToYHto4B_dipoleRecoilOn_TuneCP5_13p6TeV_madgraph_pythia8.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_lhegensim.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'TauDecays:externalMode=2SpaceShower:dipoleRecoil = on'
        ),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(123456)
